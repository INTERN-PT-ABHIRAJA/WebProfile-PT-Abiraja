                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <?php echo e($company->kategori ? $company->kategori->nama_kategori : 'Tidak ada kategori'); ?>

                        </td>
                        <td class="px-6 py-4 text-sm text-gray-500">
                            <?php echo e(\Illuminate\Support\Str::limit($company->alamat, 50)); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <?php echo e($company->berdiri_sejak ? $company->berdiri_sejak->format('d M Y') : '-'); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="<?php echo e(route('dashboard.companies.edit', $company->id_anak_perusahaan)); ?>" class="text-primary-600 hover:text-primary-900 mr-3">Edit</a>
                            
                            <form action="<?php echo e(route('dashboard.companies.delete', $company->id_anak_perusahaan)); ?>" method="POST" class="inline-block">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\kuliah\semester 4\Proyek Konsultasi\abhiraja\WebProfile-PT-Abiraja\resources\views/dashboard/companies/index.blade.php ENDPATH**/ ?>