    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">            
            <div class="modal-header">
                <div>
                    <h5 class="modal-title"><?php echo e(__('site.hubungi_kami')); ?></h5>
            ...
            <div class="modal-body">
                ...
                <form id="contactForm" class="needs-validation" novalidate>
                    ...
                    <div class="mb-3">
                        <label for="name" class="form-label"><?php echo e(__('site.full_name')); ?></label>
                    ...
                    <div class="mb-3">
                        <label for="email" class="form-label"><?php echo e(__('site.email')); ?></label>
                    ...
                    <div class="mb-3">
                        <label for="phone" class="form-label"><?php echo e(__('site.phone_number')); ?></label>
                    ...
                    <div class="mb-3">
                        <label for="message" class="form-label"><?php echo e(__('site.message')); ?></label>
            ...
            <div class="modal-footer">                
                <button type="button" class="btn-modal" data-bs-dismiss="modal"><?php echo e(__('site.cancel')); ?></button>
                <button type="button" class="btn-modal btn-whatsapp" id="submitContactForm" onclick="handleContactSubmit(event)">
                    <i class="fab fa-whatsapp me-2"></i><?php echo e(__('site.send')); ?>
...
</script><?php /**PATH D:\kuliah\semester 4\Proyek Konsultasi\abhiraja\WebProfile-PT-Abiraja\resources\views/modals/contactModal.blade.php ENDPATH**/ ?>