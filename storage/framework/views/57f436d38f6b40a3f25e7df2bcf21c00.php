...
<head>
    ...
    <title><?php echo e(config('app.name', 'PT ABHIRAJA GIOVANNI TRYAMANDA')); ?> - Dashboard</title>
        ...
        <aside id="sidebar" class="sidebar w-64 fixed inset-y-0 z-20 shadow-xl">
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-2 py-4 space-y-2">
                    <!-- Dashboard -->
                    <a href="<?php echo e(route('dashboard.index')); ?>" class="sidebar-nav-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('dashboard.index') ? 'active' : ''); ?>">
                    ...
                    ?>
                    <?php $__currentLoopData = $dashboardTables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tableKey => $tableConfig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(isset($tableConfig['permissions']) && in_array(auth()->user()->role, $tableConfig['permissions'])): ?>
                            <a href="<?php echo e(route('dashboard.' . $tableConfig['route_name'] . '.index')); ?>" class="sidebar-nav-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('dashboard.' . $tableConfig['route_name'] . '*') ? 'active' : ''); ?>">
                                <div class="sidebar-icon">
                                    <?php echo $tableConfig['icon']; ?>

                                </div>
                                <?php echo e(App::isLocale('id') ? $tableConfig['name_id'] : $tableConfig['name']); ?>
                    ...
                    <!-- Media (if exists) -->
                    <?php if(Route::has('dashboard.media.index')): ?>
                    <a href="<?php echo e(route('dashboard.media.index')); ?>" class="sidebar-nav-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('dashboard.media.*') ? 'active' : ''); ?>">
                        <svg class="sidebar-icon" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="px-4 py-4 border-t border-slate-500/50">
                    <div class="flex items-center">
                        <div class="w-8 h-8 bg-gradient-to-br from-slate-400 to-slate-500 rounded-full flex items-center justify-center shadow-md">
                            <span class="text-white text-sm font-bold"><?php echo e(substr(auth()->user()->name ?? 'Admin', 0, 1)); ?></span>
                        </div>
                        <div class="ml-3">
                            <p class="text-sm font-medium text-slate-200"><?php echo e(auth()->user()->name ?? 'Administrator'); ?></p>
                            <p class="text-xs text-slate-400"><?php echo e(auth()->user()->email ?? 'admin@abhiraja.com'); ?></p>
                        </div>
                    </div>
        ...
        <div class="flex flex-col flex-1 ml-64">
            ...
            <header class="top-bar h-16 shadow-sm flex items-center px-6">
                ...
                <div class="ml-auto flex items-center space-x-4">
                    <!-- Visit Website Link -->
                    <a href="<?php echo e(url('/')); ?>" target="_blank" class="user-dropdown flex items-center text-sm font-medium text-gray-700 hover:text-emerald-600 transition-colors">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <p class="text-sm font-medium text-gray-800"><?php echo e(auth()->user()->name ?? 'Administrator'); ?></p>
            ...
            <footer class="bg-gradient-to-r from-slate-50 to-gray-50 p-4 border-t border-gray-200 text-center">
                <div class="flex items-center justify-center text-sm text-gray-600">
                    ...
                    &copy; <?php echo e(date('Y')); ?> PT ABHIRAJA GIOVANNI TRYAMANDA. All rights reserved.
                </div>
            </footer>
        </div>
    </div>
...
<?php /**PATH D:\kuliah\semester 4\Proyek Konsultasi\abhiraja\WebProfile-PT-Abiraja\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>