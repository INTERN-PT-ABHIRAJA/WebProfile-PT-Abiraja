...
<?php $__env->startSection('content'); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
        <!-- Statistik Visual -->
        <div class="bg-gradient-to-br from-white/95 to-slate-50/95 backdrop-blur-sm rounded-lg shadow-sm border border-gray-200 p-4 h-fit">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <!-- Recent Activities -->
        <div class="lg:col-span-2 bg-gradient-to-br from-white/95 to-slate-50/95 backdrop-blur-sm rounded-lg shadow-sm border border-gray-200 p-4">
            <h3 class="text-lg font-semibold mb-4 text-gray-800 flex items-center">
        ...
        <!-- Business Overview -->
        <div class="bg-gradient-to-br from-white/95 to-slate-50/95 backdrop-blur-sm rounded-lg shadow-sm border border-gray-200 p-4">
            <h3 class="text-lg font-semibold mb-4 text-gray-800 flex items-center">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\kuliah\semester 4\Proyek Konsultasi\abhiraja\WebProfile-PT-Abiraja\resources\views/dashboard/index.blade.php ENDPATH**/ ?>